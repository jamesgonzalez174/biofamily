...
BEGIN
  ...
  INSERT INTO public.redemptions (user_id, prize_id, prize_name, points_spent, status, shipping_address, contact_phone)
  VALUES (_user_id, _prize.id, _prize.name, _prize.point_cost, 'pending',
          NULLIF(trim(_shipping_address), ''), NULLIF(trim(_contact_phone), ''))
  RETURNING * INTO _red;
