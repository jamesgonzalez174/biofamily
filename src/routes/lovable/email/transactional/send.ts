  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Restrict to admins — prevents arbitrary authenticated users from sending
        // branded emails to any address. Server-to-server callers should use
        // sendTransactionalEmailServer() (service role) instead.
